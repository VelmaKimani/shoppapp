...
class _ProductsOverviewScreenState extends State<ProductsOverviewScreen> {
  ...
  @override
  void initState() {
    //Provider.of<Products>(context).fetchAndSetProducts(); // alone has an error. With listen : false it can work
    /* Future.delayed(Duration.zero)
        .then((_) => Provider.of<Products>(context).fetchAndSetProducts()); */ //can work with modal route of
    super.initState();
  }
